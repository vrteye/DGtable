"""
财务报相关项目情况 finance_report_item_Finance
"""
import requests
import numpy as np
from basic import *

def FinancereportitemFinance(path, tradeKey):
    # print(tradeKey)
    try:
        ...
        # print(data)
        Success = requests.post('http://192.168.1.200:9008/financeReportItemFinance/add', json=data)
        print(Success)
